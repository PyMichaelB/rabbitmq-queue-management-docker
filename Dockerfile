...
RUN apt-get update -y -q \
    ...
    && git clone https://github.com/gessnerfl/rabbitmq-queue-management.git \
    && cd rabbitmq-queue-management \
...
COPY --from=builder /rabbitmq-queue-management/build/libs/rabbitmq-queue-management-${RABBITMQ_QUEUE_MGMT_VERSION}.jar rabbitmq-queue-management.jar
